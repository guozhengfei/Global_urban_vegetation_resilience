...
if __name__ == '__main__':
    ...
    tac_folder = current_dir + '/2_Output/var_500_yr/'
    ...
    IDs_num = []
    for id in IDs[1:]:
        tac = np.load(tac_folder + 'var_yearly_mean_' + id + '.npy')[:,:,2:-2]
        # tac[tac<=0]=np.nan
    ...
    output_file = current_dir + '/2_Output/' + 'tac_nadir_city_3zones_cv' + '.npz'

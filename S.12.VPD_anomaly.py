...
if __name__ == '__main__':
    ...
    Data_folder = '/Volumes/Zhengfei_01/urban_env_data/VPD_Terraclimate_urban/'
    output_folder = current_dir + '/1_Input/vpd_anom/'
    ...
    for id in IDs:
        ...
        data_i = tf.imread(Data_folder + 'VPD_monthly_' + str(id) + '.tif')#[:, :, :264 * 2]
        ...
        VPD_anom = res.reshape(data_rsp_i.shape)

        np.save(output_folder + 'vpd_month_anomaly_'+str(id)+'.npy', VPD_anom)
        print(id)

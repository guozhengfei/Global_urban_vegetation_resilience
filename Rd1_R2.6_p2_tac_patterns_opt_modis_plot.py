...
relative_path = '/2_Output/tac_nadir_city_3zones_all_no_climate_adjust.npz'
...
figToPath = current_dir + '/4_Figures/FigS01_tac_patterns_regression_MODIS_no_climate_adjust'
fig.tight_layout()

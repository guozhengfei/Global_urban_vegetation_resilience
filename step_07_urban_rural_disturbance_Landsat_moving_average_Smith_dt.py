...
if __name__ == '__main__':
    ...
    for id in IDs[1:]:
        ...
        threshold = mean_all - 1.0 * std  # threshold for extreme events
        ...
        output_file_dt_VI = current_dir + '/2_Output/tac_Landsat/' + 'dt_VI_' + str(id) + '.npy'
        ...
        np.save(output_file_dt_VI, dt_VI_values)

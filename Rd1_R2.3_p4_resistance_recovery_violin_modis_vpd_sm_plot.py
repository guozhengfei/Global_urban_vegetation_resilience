...
# load Landsat TAC
relative_path = '/2_Output/tac_nadir_city_3zones_modis_no_disturbance_vpd_sm.npz'
...
fig.tight_layout()
plt.savefig(os.path.join(current_dir, '4_Figures', 'recovery_resistance_TAC_modis_d_e_vpd_sm.png'), dpi=900)
plt.show()

...
cities.plot('urban_core',ax=ax[0], marker='o',  markersize=10, cmap='RdBu_r',vmin=0.08,vmax=0.25)
ax[0].set_ylim([-54,80])
...
cities.plot('urban_edge',ax=ax[1], marker='o',  markersize=10,cmap='RdBu_r',vmin=0.08,vmax=0.25)
ax[1].set_ylim([-54,80])
...
cities.plot('rural_bgr',ax=ax[2], marker='o',  markersize=10,cmap='RdBu_r',vmin=0.08,vmax=0.25)
ax[2].set_ylim([-54,80])

...
if __name__ == '__main__':
    ...
    folder = current_dir + '/2_Output/sensitivity_analysis/'
    ...
    IDs = np.sort(IDs)
    for id in IDs:
        df_i = pd.read_csv(folder+'NDVI_8d_4000_'+str(id)+'.csv').astype(float)
        ...
        output_file = current_dir + '/2_Output/sensitivity_analysis/' + 'tac_4000_' + str(id) + '.npy'

...
if __name__ == '__main__':
    ...
    Data_folder = os.path.dirname(current_dir) + 'urban_env_data/Percipitation_urban/'
    ...
    for id in IDs:
        ...
        data_i = tf.imread(Data_folder + 'precipitation_monthly_' + str(id) + '.tif')#[:, :, :264 * 2]
        ...
        np.save(current_dir + '/1_Input/pre_anom/pr_month_anomaly_'+str(id)+'.npy', Ta_anom)
        print(id)

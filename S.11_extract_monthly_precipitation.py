...
for n in range(0, 23*12):
    ...
    evi = ((ee.ImageCollection('ECMWF/ERA5_LAND/MONTHLY_AGGR')
              ...
              .select('total_precipitation_sum')).mosaic();
    imagecollections.append(evi)

FVC = ee.ImageCollection.fromImages(imagecollections).select('total_precipitation_sum').toBands()
...
for city in cities[2:]:
    ...
    dscr = 'precipitation_monthly_'+str(geo['ID'][0])
    print(dscr)

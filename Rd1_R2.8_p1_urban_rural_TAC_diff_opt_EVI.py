...
if __name__ == '__main__':
    ...
    EVI_folder = '/Volumes/Zhengfei_02/Zhengfei_01-BACKUP/project 3 urban resilience/1_Input/nadir_evi_monthly_500m/'
    ...
    IDs_num = []
    for id in IDs[1:]:
        EVI0 = tf.imread(EVI_folder + 'nadir_evi_monthly_' + str(id) + '.tif')[:, :, :264]
    ...
    output_file = current_dir + '/2_Output/' + 'tac_nadir_evi_city_3zones_all' + '.npz'

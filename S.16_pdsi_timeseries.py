...
imageC = ee.ImageCollection('IDAHO_EPSCOR/TERRACLIMATE').select('pdsi').filterDate('2001-01-01', '2023-01-01').toBands()
...
# Save to CSV
output_path = os.path.join(current_dir, '2_Output', 'pdsi_timeseries_all.csv')

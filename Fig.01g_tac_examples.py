...
if __name__ == '__main__':
    ...
    ids = ['147.0', '191.0', '334.0', '936.0']  # Get four IDs for the subplots
    ...
    for i, ax in enumerate(axes.flat):  # Iterate over each subplot
        ...
        im = ax.imshow(np.ma.masked_invalid(tac_spa_mean_resized), cmap=cmap, vmin=p05, vmax=p95, alpha=0.75)
        ...
        custom_cmap = ListedColormap(['#810f7c', '#000000', '#e31a1c'])
    ...
    # Save the figure
    figToPath = current_dir + '/4_Figures/Fig01g_tac_example'

...
def load_tac(current_dir, rolling_years):
    path = current_dir + f'/2_Output/tac_nadir_city_3zones_deseason{rolling_years}yr.npz'
    data = np.load(path)
...
if __name__ == '__main__':
    ...
    axes[0, 1].set_title('Deseasoning window: 7 year')
    axes[1, 1].set_title('Deseasoning window: 8 year')

    fig_to_path = current_dir + '/4_Figures/Rd1_R2_9_temporal_tac_opt_modis_deseason_windows'

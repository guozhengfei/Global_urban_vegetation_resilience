...
if __name__ == '__main__':
    ...
    for id in IDs:
        ...
        output_file = current_dir + '/2_Output/tac_Landsat/' + 'tac_' + str(id) + '_all.npy'
    ...
    plt.figure();
    for id in IDs:
        tac_1 = np.load(current_dir + '/2_Output/tac_Landsat/' + 'tac_' + str(id) + '.npy')
        tac_1 = np.nanmean(tac_1,axis=1)
        tac_2 = np.load(current_dir + '/2_Output/tac_Landsat/' + 'tac_' + str(id) + '_all.npy')
        # plt.plot(tac_1,tac_2,'o')
        print(st.linregress(tac_1,tac_2).rvalue)

...
cities.plot('core_rural_diff', ax=ax[0], marker='o', markersize=10, cmap='BrBG_r', vmin=-0.1, vmax=0.05)
...
# Plot using pcolor
c = ax[2].pcolor(x_edges, y_edges, heatmap_data, cmap='BrBG_r', edgecolors='k', linewidths=0.5, vmin=-0.1, vmax=0.05)
...
figToPath = current_dir + '/4_Figures/Fig02_urban_rural_diff_modis'
fig.tight_layout()

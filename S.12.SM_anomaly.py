...
if __name__ == '__main__':
    ...
    Data_folder = '/Volumes/Zhengfei_01/urban_env_data/SM_Terraclimate_urban/'
    output_folder = current_dir + '/1_Input/sm_anom/'
    ...
    for id in IDs:
        ...
        data_i = tf.imread(Data_folder + 'SM_monthly_' + str(id) + '.tif')#[:, :, :264 * 2]
        ...
        SM_anom = res.reshape(data_rsp_i.shape)

        np.save(output_folder + 'sm_month_anomaly_'+str(id)+'.npy', SM_anom)
        print(id)

...
figToPath = current_dir + '/4_Figures/Fig03_urban_rural_diff_trend_landsat'
fig.tight_layout()
fig.savefig(figToPath, dpi=900)
# plt.close(fig)

df_tac2 = df_tac.loc[df_tac['tac_diff_slope_sig'] !=0]
plt.figure(figsize=(1.4, 1.4))
plt.hist(df_tac['tac_diff_slope_sig'], 17, [-0.0005,0.0005],color='lightcoral', alpha=0.7,edgecolor='k')
plt.xlabel('TAC trend')
plt.xticks([-0.0005,0, 0.0005],['-5.0','0','5.0'])
plt.tight_layout()
figToPath = current_dir + '/4_Figures/Fig03_urban_rural_diff_trend_landsat_hist'

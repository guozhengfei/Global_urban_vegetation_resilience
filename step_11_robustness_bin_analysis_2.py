...
if __name__ == '__main__':
    ...
    for id in IDs:
        ...
        mask1 = (vf_gra >= vf_tree) & (vf_gra >= 0.2) # grass-dominant pixels
        mask2 = (vf_gra < vf_tree) & (vf_tree >= 0.2) # tree-dominant pixels
        tac_3zone=[]
    ...
    fig, axs = plt.subplots(2, 3, figsize=(7.5* 0.9, 1.82* 0.9*2),width_ratios=[2,1,1])
    ...
    figToPath = current_dir + '/4_Figures/sensitivity_tac_3zones_bar_vegetation_type'

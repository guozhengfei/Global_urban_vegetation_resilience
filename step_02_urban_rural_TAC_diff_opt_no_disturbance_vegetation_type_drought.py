...
if __name__ == '__main__':
    ...
    for str_name in str_names:
        ...
        for id in IDs[1:]:
            ...
            distur = np.load(disturbance_folder + 'extreme_events_' + str(id) + '_smith_2sd_'+str_name+'.npy')
        ...
        output_file = current_dir + '/2_Output/' + 'tac_nadir_city_3zones_modis_no_disturbance_2sd_'+str_name+'.npz'

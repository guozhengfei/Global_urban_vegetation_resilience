...
ax[0].title.set_text('Global cities')
ax[1].title.set_text('Global cities')
ax[2].title.set_text('Global cities')
ax[3].title.set_text('Global cities')
...
figToPath = current_dir + '/4_Figures/FigS01_tac_patterns_regression_MODIS_lag-2'
fig.tight_layout()

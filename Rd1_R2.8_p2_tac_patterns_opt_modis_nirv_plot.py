...
relative_path = '/2_Output/tac_nadir_nirv_city_3zones_all.npz'
...
ax[0].set_ylabel('NIRv-based TAC')
...
ax[1].set_xlabel('NIRv-based TAC$_{UC}$')
ax[1].set_ylabel('NIRv-based TAC$_{UE}$')
ax[1].set_xlim([-0.02, 0.52])
ax[1].set_ylim([-0.02, 0.52])
ax[2].set_xlabel('NIRv-based TAC$_{UC}$')
ax[2].set_ylabel('NIRv-based TAC$_{RA}$')
...
figToPath = current_dir + '/4_Figures/FigS01_tac_patterns_regression_MODIS_nirv'
fig.tight_layout()

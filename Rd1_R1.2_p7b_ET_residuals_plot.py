...
fig_selected, axs_selected = plt.subplots(2, 3, figsize=(13.2*0.8, 6.2*0.8))
...
plt.tight_layout()
figSelectedPath = current_dir + '/4_Figures/Rd1_R1_2_ET_residuals_selected_diagnostics_2x3'
...
plt.tight_layout()
figToPath = current_dir + '/4_Figures/Rd1_R1_2_ET_residuals_all_vegetation'

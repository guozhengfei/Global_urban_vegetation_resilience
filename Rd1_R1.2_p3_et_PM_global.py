...
lst_path = os.path.join('..', '2_Output', 'pure_veg', 'monthly_landsat_lst_100.csv')
...
new_columns[7:19] = ['lst_m1','lst_m2','lst_m3','lst_m4','lst_m5','lst_m6',
                     'lst_m7','lst_m8','lst_m9','lst_m10','lst_m11','lst_m12']
our_ET_df.columns = new_columns
output_path = os.path.join('..', '2_Output', 'pure_veg', 'monthly_landsat_et_PM_global_100.csv')

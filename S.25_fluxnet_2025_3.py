...
if __name__ == "__main__":
    ...
    shapefile_dir = os.path.join('..', '..', 'urban_env_data', 'GUB_Global_2018', 'GUB_Global_2018.shp')

    csv_file = AMF_site_dir # CSV file with latitude/longitude columns
    # csv_file = ICOS_site_dir
    shapefile = shapefile_dir  # Shapefile with polygons

    # Check points against polygons
    result = check_points_in_polygons(csv_file, shapefile)
    result = result.loc[result['in_polygon']]

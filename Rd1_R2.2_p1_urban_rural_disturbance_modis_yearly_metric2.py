...
if __name__ == '__main__':
    ...
    for id in IDs[1:]:
        ...
        for n_sd in CORE_SD_LEVELS:
            ...
            dVI_out[disturbance_label] = 2*residuals[disturbance_label] / (vis_mean_pixel[disturbance_label]+residuals[disturbance_label])
            ...
            np.save(f"{output_folder}dVI_metric2_{suffix}", dVI_out)
            print(suffix)

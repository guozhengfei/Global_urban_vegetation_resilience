...
if __name__ == '__main__':
    ...
    output_file = current_dir + '/2_Output/' + 'tac_nadir_city_3zones' + '.npz'
    ...
    TAC_arr_yearly = TAC_arr
    
    # Calculate linear trends (750 cities × 3 regions)
    TAC_trends = np.zeros((711, 3))
    for city in range(711):
    ...
    # Save to CSV
    output_csv = os.path.join(current_dir, '2_Output', 'tac_trends_modis.csv')

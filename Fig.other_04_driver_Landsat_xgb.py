...
df_xgb = df_tac[['urban_irri','Q_diff', 'ntl_diff', 'pop_diff', 'uhi','co2_diff','AI', 'SW', 'MAT','MAP', 'tac_diff']]#'vpd',
...
background_factors = ['AI', 'SW', 'MAT','MAP',] # vpd
...
for i in range(4):
    ...
    # Determine variables
    val_label = ['urban_irri', 'pop_diff', 'AI', 'AI']
    col_label = ['AI', 'AI', 'urban_irri', 'uhi']

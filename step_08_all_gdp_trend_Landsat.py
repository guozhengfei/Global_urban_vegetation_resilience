...
if __name__ == '__main__':
    ...
    df_trends = pd.DataFrame(trends_arr,
                             columns=['ID','uc_gdp_trend', 'ue_gdp_trend', 'gpd_trend_diff'])

    output_csv = os.path.join(current_dir, 'project 3 urban resilience', '2_Output', 'gdp_trends.csv')
    ...
    # Save figure
    plt.savefig(os.path.join(current_dir, '4_Figures', 'gdp_trend_correlations_heatmap.png'),

...
def load_data():
    ...
    return urban_factors, co2, vpd, ntl_vegc_ndvi, pop, climate, AI, ch
...
# Load all data
urban_factors, co2, vpd, ntl_vegc_ndvi, pop, climate, AI, ch = load_data()
...
plt.ylim([-0.36,0.32])
plt.xticks(range(8),['SW', 'AI', 'UI', 'ΔGDP', 'ΔPOP', 'UHI', 'ΔCO2',  'ΔHc'], ha='right')
plt.tight_layout()
...
for i in range(4):
    ...
    # Determine variables
    val_label = ['urban_irri', 'ch_diff', 'ntl_diff', 'AI']
    col_label = ['AI', 'AI', 'AI', 'urban_irri']
    labels = ['UI', 'ΔHc', 'ΔGPD', 'AI']
